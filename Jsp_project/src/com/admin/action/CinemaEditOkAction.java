...
public class CinemaEditOkAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		int res1 = sdao.seatEditOk(seat_no1, cinemacode, 1);
		int res2 = sdao.seatEditOk(seat_no2, cinemacode, 2);
		int res3 = sdao.seatEditOk(seat_no3, cinemacode, 3);
		int res4 = sdao.seatEditOk(seat_no4, cinemacode, 4);
		int res5 = sdao.seatEditOk(seat_no5, cinemacode, 5);
		int res6 = sdao.seatEditOk(seat_no6, cinemacode, 6);
