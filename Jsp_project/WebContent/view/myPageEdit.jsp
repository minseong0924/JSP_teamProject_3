          ...
          if ($("#userphone").val().length >= 11) {
            $.ajax({
               ...
               success: function(data) {
                  if($.trim(data) == 1 && (beforePhone != $("#userphone").val())) {
                     let warningTxt = '<font color="red">이미 존재하는 연락처입니다.</font>';
                     $("#phcheck").text("");
                     $("#phcheck").show();
                     $("#phcheck").append(warningTxt);
                     $("#phcheck_hidden").val("");
                  } else if(($.trim(data) == 0) || (beforePhone == $("#userphone").val())){
...
<body>
   ...
   <div class="join_all_div" align="center">
      ...
      <div class="join_title_div">개인정보 수정</div>
         ...
         <table class="memJoin">
            ...
            <tr>
               ...
               <td>
                  ...
                  <input type="hidden" id="phcheck_hidden" value="1">
               </td>
            </tr>
            <tr>
                 <td colspan="2" align="center">
                  <button type="submit" class="btn join_btn">수정</button>
                  <button type="button" class="btn cancle_btn"
                     onclick="history.back()">돌아가기</button>
                  <br><br><br>
                  <button type="button" class="btn cancle_btn" style="background-color: red;"
